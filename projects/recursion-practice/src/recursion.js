...
var arraySum = function(array) { //OPTIONAL
};//OPTIONAL
...
var reverse = function(string, def='') {
      ...
      //recursion
      def += string[string.length - 1]
      return reverse(string.slice(0, -1), def)
};

// 10. Write a function that determines if a string is a palindrome.
var palindrome = function(string, back, front) {
  back = string.charAt(string.length - 1);
  front = string.charAt()
      //base
      if(string.length === 0){
       return true
      ...
      if(front.toLowerCase() === back.toLowerCase()) 
    return palindrome(string.slice(front, back))
};
...
// modulo(17,5) // 2
// modulo(22,6) // 4
var modulo = function(x, y) {//OPTIONAL
};//OPTIONAL
...
// JavaScript's Math object.
var divide = function(x, y) {//OPTIONAL
};//OPTIONAL
