 ...
 *  more often than not, the computer may run accross structures, such as conditionals and loops, that will change that. These structures can alter the Control Flow, 
 ...
 *  operates each step, while Declarative is about the 'what'; what the program should accomplish. Therefore the control flow is Imperative Programming
 *  due to the 'flow' or steps its taking.
 *  
 * 1. Conditionals: A set of rules that is capable of interupting, or even change, normal code execution dependant on if the condition is met or not.
 *      Some examples of a conditional is an if-elseif-else statement or a switch statement.
 * 
 */
